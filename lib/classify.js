...
// Utiliza a Matriz Ontológica de Avaliação com limites dinâmicos para Ações e FIIs.

// ---------------------------------------------------------------------------
// AÇÕES — Matriz Ontológica Quântica
// ---------------------------------------------------------------------------
const PERFIS_ACOES = {
  conservador: {
  ...
  arrojado: {
    pl: { bomMin: 0, bomMax: 20, ruimAbaixoDe: 0, ruimAcimaDe: 30 },
    pvp: { bomMin: 0, bomMax: 3.0, ruimAbaixoDe: 0, ruimAcimaDe: 5.0 },
    // DY é omitido no Arrojado (sempre será neutro, foco é crescimento)
    roe: { bomMin: 15, ruimAbaixoDe: 10 },
    roic: { bomMin: 15, ruimAbaixoDe: 10 },
    margemLiquida: { bomMin: 10, ruimAbaixoDe: 5 },
    divLiqPatrimonio: { bomMax: 1.2, ruimAcimaDe: 2.0 },
    divLiqEbitda: { bomMax: 3.0, ruimAcimaDe: 4.0 },
    liquidezCorrente: { bomMin: 1.0, ruimAbaixoDe: 0.6 },
    payout: { bomMax: 40, ruimAcimaDe: 70 }, // Arrojado exige reinvestimento do lucro
...
const PERFIS_FII = {
  conservador: {
    // Anti-Value Trap aplicado: P/VP abaixo de 0.80 vira 'bad' por risco oculto
    pvp: { bomMin: 0.90, bomMax: 1.00, ruimAbaixoDe: 0.80, ruimAcimaDe: 1.05 },
    dy: { bomMin: 8, bomMax: 11, ruimAbaixoDe: 6, ruimAcimaDe: 12 },
  ...
  moderado: {
    ...
    dy: { bomMin: 9, bomMax: 13, ruimAbaixoDe: 7, ruimAcimaDe: 14 },
